...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
        ...
        userRepository.save(newUser); // stores the new user in the database
...
// This removes all data from the session, so that when the user makes a subsequent request,
